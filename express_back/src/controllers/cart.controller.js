...
class CartController {
    ...
    async addItem(req, res) {
        try {
            ...
            const savedCart = await cartRepository.upsertByCartId(cartId, { items, totalAmount });
    ...
    async setItemQuantity(req, res) {
        try {
            ...
            if (rawItems.length === 0) {
                const clearedCart = await cartRepository.upsertByCartId(cartId, { items: [], totalAmount: 0 });
    ...
    async clear(req, res) {
        try {
            ...
            const cart = await cartRepository.upsertByCartId(cartId, { items: [], totalAmount: 0 });
    ...
    async checkout(req, res) {
        try {
            ...
            await cartRepository.upsertByCartId(cartId, { items: [], totalAmount: 0 });
